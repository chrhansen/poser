...
class TestMediaPipeWorldLandmarks:
    ...
    def test_get_world_landmarks_returns_correct_shape(self, mock_mediapipe_detector, sample_frame, sample_bbox):
        ...
        # Test
        world_landmarks = mock_mediapipe_detector.get_world_landmarks(sample_frame, sample_bbox)
    ...
    def test_get_world_landmarks_none_when_no_detection(self, mock_mediapipe_detector, sample_frame, sample_bbox):
    ...
    def test_get_world_landmarks_uses_different_timestamp(self, mock_mediapipe_detector, sample_frame, sample_bbox):
        ...
        mock_mediapipe_detector.detector.detect_for_video.side_effect = capture_timestamp
    ...
    def test_detect_returns_z_coordinates(self, mock_mediapipe_detector, sample_frame, sample_bbox):
    ...
    def test_world_landmarks_in_meters(self, mock_mediapipe_detector, sample_frame, sample_bbox):
        ...
        assert np.all(world_landmarks[:, 1] >= -0.1)  # Y above ground (-0.1 for tolerance)
