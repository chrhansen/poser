...
class TestYOLOKeypointFormat:
    ...
    def mock_yolo_detector(self):
        ...
        cfg = {"yolo_model": "yolo11n-pose", "confidence": 0.5}
    ...
    def test_detect_returns_4_element_keypoints(
        self, mock_yolo_detector, sample_frame, sample_bbox
    ):
    ...
    def test_detect_handles_no_keypoints(
        self, mock_yolo_detector, sample_frame, sample_bbox
    ):
