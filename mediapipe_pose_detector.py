...
class MediaPipePoseDetector(PoseDetectorBase):
    ...
    def __init__(self, cfg: dict):
        ...
        super().__init__(cfg)
        self.detector = None
        self.model_path = cfg.get('mediapipe_model_path', 'models/pose_landmarker_heavy.task')
    ...
    def _detect_keypoints(self, image: np.ndarray) -> Optional[np.ndarray]:
        ...
        # Run detection
        detection_result = self.detector.detect_for_video(mp_image, self.last_timestamp_ms)
